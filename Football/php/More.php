...
<head>
  ...
  <title>Real Madrid -
    <?php echo GetOpponent(3 /*Match_ID*/) ?>
  </title>
</head>
...
<body>
  ...
  -->
    ...
    <body>
      ...
      <h6>Your expectation should be in this order: Real Madrid -
        <?php echo GetOpponent(3 /*Match_ID*/) ?>
      </h6>

      <?php if (checkScore(2 /*Fan_id*/, 3 /* Match_ID */) == NULL) { ?>
        <form id="myForm" action="expectation.php" method="post">
          <input type="text" id="Exp" name="Exp" class="Expectation" placeholder="0-0" required>
          <input type="hidden" name="match" value="3"> <!-- value="Match_ID"-->
          <input type="hidden" name="id" value="2"> <!-- value="FAN_ID"-->
          <input type="submit" value="submit">
        </form>
      <?php } else
        echo "Your expected score is " . checkScore(2 /*Fan_id*/, 3 /* Match_ID */) . "" ?>



        <form id="points-form" action="Points.php" method="post">
          <input type="submit" id="collect-points-button" value="Collect Points">
          <input type="hidden" name="M_id" value="3"> <!-- value="Match_ID"-->
          <input type="hidden" name="id" value="2"> <!-- value="FAN_ID"-->
        </form>
        <hr><br>
  ...
  -->
      ...
      <?php if (checkFeed(2 /*Fan_id*/) == NULL) { ?>
    ...
    -->
      <?php $a_users = FetchUsers(3 /*Match_ID*/) ?>
              ...
              <td>
                ...
                if (CheckAvailbility($user->CARPOOL_ID) != "C") {
                  ...
                  <form method="post" action="Reserve.php">
                    ...
                    <input type="hidden" name="Fan_id" value="2">
    ...
    which contains the location of the ride and the capacity and then it will be sent to DB. -->
      ...
      <div id="myPopup" class="popup">
        <form action="AddCarpool.php" method="post">
          ...
          <input type="hidden" name="match" value="3"> <!-- Match_ID -->
          <input type="hidden" name="d_id" value="2"> <!-- FAN_ID -->
    ...
    who reserve a seat with the user if the user added a drive for a specific match. -->
      ...
      <?php $a_users2 = GetPassengers(2 /*Fan_id*/, 3 /* Match_ID */); ?>
      <table class="my-table">
        <thead>
          <tr>
            <th>Name</th>
        ...
        for ($i = 0; $i < sizeof($a_users2); $i++) {
          ...
          <tbody name="tbody">
            <tr>
              <td>
                <?php GetName($a_users2[$i]->PASSENGER_ID) ?>
              </td>
              <td>
