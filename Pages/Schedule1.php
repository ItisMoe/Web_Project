...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="../css/schedule_css/style.css">

    <link rel="stylesheet" href="../css/schedule_css/bootstrap.min.css">
    <link rel="stylesheet" href="../css/schedule_css/magnific-popup.css">
    <link rel="stylesheet" href="../css/schedule_css/jquery-ui.css">
    <link rel="stylesheet" href="../css/schedule_css/owl.carousel.min.css">
    <link rel="stylesheet" href="../css/schedule_css/owl.theme.default.min.css">


    <link rel="stylesheet" href="../css/schedule_css/aos.css">

    <link rel="stylesheet" href="../css/schedule_css/style_updated.css">
  ...
  <div class="site-wrap">
    ...
    <div class="site-mobile-menu">
      <div class="site-mobile-menu-header">
        <div class="site-mobile-menu-logo">
          <a href="#"><img src="../images/schedule_images/logo.png" alt="Image"></a>
        </div>
    ...
    <header class="site-navbar absolute transparent" role="banner">
      ...
      <nav class="site-navigation position-relative text-right bg-black text-md-right" role="navigation">
        <div class="container position-relative">
          <div class="site-logo">
            <a href="index.html"><img src="../images/schedule_images/logo.png" alt=""></a>
          </div>
    ...
    <div class="site-blocks-cover overlay" style="background-image: url(../images/schedule_images/hero_bg_3.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
    ...
    <div class="site-section site-blocks-vs">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="bg-image overlay-success rounded mb-5" style="background-image: url('../images/schedule_images/hero_bg_1.jpg');" data-stellar-background-ratio="0.5">
              ...
              <div class="text-center text-lg-left">
                <div class="d-block d-lg-flex align-items-center">
                  <div class="image mx-auto mb-3 mb-lg-0 mr-lg-3">
                    <img src="../images/schedule_images/img_1_sq.jpg" alt="Image" class="img-fluid">
                  </div>
                  <div class="text">
              ...
              <div class="">
                <div class="d-block d-lg-flex align-items-center">
                  <div class="image mx-auto ml-lg-3 mb-3 mb-lg-0 order-2">
                    <img src="../images/schedule_images/img_4_sq.jpg" alt="Image" class="img-fluid">
                  </div>
              ...
              <div class="ml-auto pr-4 order-md-2">
                <div class="h5 text-black text-uppercase text-center text-lg-left">
                  <div class="d-block d-md-inline-block mb-3 mb-lg-0">
                    <img src="../images/schedule_images/img_1_sq.jpg" alt="Image" class="mr-3 image"><span class="d-block d-md-inline-block ml-0 ml-md-3 ml-lg-0">Sea Hawlks </span>
                  </div>
                  <span class="text-muted mx-3 text-normal mb-3 mb-lg-0 d-block d-md-inline ">vs</span> 
                  <div class="d-block d-md-inline-block">
                    <img src="../images/schedule_images/img_3_sq.jpg" alt="Image" class="mr-3 image"><span class="d-block d-md-inline-block ml-0 ml-md-3 ml-lg-0">Patriots</span>
                  </div>
                </div>
              </div>
            ...
            <div class="row bg-white align-items-center ml-0 mr-0 py-4 match-entry">
              ...
              <div class="col-md-4 col-lg-4 text-center text-lg-right">
                <div class="">
                  <div class="d-block d-lg-flex align-items-center">
                    <div class="image image-small ml-lg-3 mb-3 mb-lg-0 order-2">
                      <img src="../images/schedule_images/img_3_sq.jpg" alt="Image" class="img-fluid">
                    </div>
                    <div class="text order-1 w-100">
        ...
        <div class="row">
                  ...
                  <li class="mb-3">
                    <a href="#" class="d-flex">
                      <figure class="image mr-4">
                        <img src="../images/schedule_images/img_1.jpg" alt="" class="img-fluid">
                      </figure>
                      <div class="text">
          ...
          <div class="col-lg-4 mb-5 mb-lg-0">
            <div class="mb-5">
              ...
              <div class="block-16">
                <figure>
                  <img src="../images/schedule_images/img_1.jpg" alt="Image placeholder" class="img-fluid rounded">
